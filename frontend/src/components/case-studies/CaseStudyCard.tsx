...
export default function CaseStudyCard({ caseStudy }: CaseStudyCardProps) {
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
        {/* Image */}
        {imgUrl && !imageError ? (
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[calc(100vh-12rem)]">
              ...
              <div className="w-full bg-gray-100">
                {(() => {
                  const modalImgUrl = hasValidImage ? (s3UriToHttps(rawImage) || rawImage) : null;
                  return modalImgUrl ? (
                    <img
                      src={modalImgUrl}
                      alt={caseStudy.name}
              ...
              <div className="p-6 space-y-6">
                ...
                {caseStudy.evaluation && typeof caseStudy.evaluation === 'object' && (() => {
                  // Collect all valid evaluation entries
